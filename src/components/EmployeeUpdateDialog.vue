...
watch(visible, async (open) => {
 ...
 formData.village_id_current_address = profile?.village_id_current ?? null
  ...
  profileImageUrl.value = profile?.profile_image
    ? `https://tp4jp1v0-8080.asse.devtunnels.ms/profileimage/${profile.profile_image}` : ''
  ...
  qrImageUrl.value = qrFile ? `https://tp4jp1v0-8080.asse.devtunnels.ms/qrcodeimage/${qrFile}` : ''
